...
const ImportQuestion = ({ closeImportQuestionModal }) => {
            ...
            try {
                for (let i = 0; i < json.length; i += batchSize) {
                    ...
                    const promises = batch.map(async (item) => {
                        const res = await axios.post(`${baseApiUrl}/question.php`, item);
                        console.log(res);
                    });
                ...
                loading ? (
                    ...
                    <>
                        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 className="text-lg mt-2 leading-6 font-medium text-gray-900" id="modal-title">Import Questions</h3>
                        ...
                        <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            ...
                            <button type="button" onClick={closeImportQuestionModal} className="mt-3 w-full inline-flex justify-center rounded-md border shadow-sm px-4 py-2 bg-white text-base font-medium focus:outline-none  sm:mt-0 sm:w-auto sm:text-sm">
                                Cancel
                            </button>
                        </div>
                    </>
