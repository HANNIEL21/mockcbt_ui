...
const AddFaculty = ({ closeAddFacultyModal }) => {
    ...
    const save = async () => {
        try {
            ...
            const response = await axios.post(`${baseApiUrl}/faculty.php`, formData);
    ...
    return (
        <div>
            ...
            <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                ...
                <button type="button" onClick={closeAddFacultyModal} className="mt-3 w-full inline-flex justify-center rounded-md border  shadow-sm px-4 py-2 bg-white text-base font-medium focus:outline-none  sm:mt-0 sm:w-auto sm:text-sm">
                    Cancel
                </button>
            </div>
        </div>
